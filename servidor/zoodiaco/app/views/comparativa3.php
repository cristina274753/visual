...
<body class="d-flex flex-column min-vh-100 bg-black text-white bg-image">
    ...
    <header class="d-flex container justify-content-between align-items-center border-bottom my-3 text-white">
        <div class="d-flex align-items-center my-1">
            ...
            <ul class="nav">
                <li><a href="index.html" class="nav-link px-3 text-light">Inicio</a></li>
                <li><a href="zodiaco.html" class="nav-link px-3 text-light">Zodíaco</a></li>
            </ul>
        </div>
            ...
            <div class="row row-cols-12 g-4">
                <div class="col">
                    <div class=" text-light text-center">
                        <div class="">
                            <a href="comparativa2"><img src="img/thumb/<?= htmlspecialchars($vehiculo['imagen_thumb']) ?>" class="img-fluid" alt="Nombre 1"
                                    style="width: 70px;"></a>
            ...
            <div class="row row-cols-4">
                ...
                <div class="col-md">
                    ...
                    <p class="text-center text-secondary">Selecciona uno de los signo1$signo1s zodiacales para conocer la
                        compatibilidad.</p>
                    <form action="comparativa3" method="POST">
                        <table class="table table-dark table-hover table-striped align-middle small">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" name="amorosa" id="compatibilidad_amorosa" class="form-control" value="<?= $comparativa['compatibilidad_amorosa'] ?>" min="0" max="100">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" name="emocional" id="compatibilidad_emocional" class="form-control" value="<?= $comparativa['compatibilidad_emocional'] ?>" min="0" max="100">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" name="laboral" id="compatibilidad_laboral" class="form-control" value="<?= $comparativa['compatibilidad_laboral'] ?>" min="0" max="100">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" name="social" id="compatibilidad_social" class="form-control" value="<?= $comparativa['compatibilidad_social'] ?>" min="0" max="100">
                                            <input type="hidden" name="s1" value="<?= htmlspecialchars($signo1['id']) ?>">
                                            <input type="hidden" name="s2" value="<?= htmlspecialchars($signo2['id']) ?>">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button type="submit" class="btn btn-outline-light btn-sm">Guardar</button>

                                        <a href="comparativa2?s1=<?= htmlspecialchars($signo1['id']) ?>&s2=<?= htmlspecialchars($signo2['id']) ?>" class="btn btn-outline-light btn-sm">Cancelar</a>
                                        <a href="zodiaco" class="btn btn-outline-light btn-sm">Volver</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="col card bg-black" style="width: 20rem;">
                    <h4 class="text-center text-secondary">Comparativa</h4>
                    <img src="img/<?= htmlspecialchars($signo2['imagen_url']) ?>" class="card-img-top" style="max-height: 600px; width: auto;"
                        alt="Imagen 1">
                    <div class="card-body bg-black text-light py-1">
                        <h5 class="card-title text-center my-0">Nombre 2: <?= htmlspecialchars($signo2['nombre']) ?></h5>
                        <p class="card-text text-secondary text-center my-0"><?= htmlspecialchars($signo2['descripcion']) ?></p>
                        <small class="text-secondary text-cursive text-center fst-italic d-block"><?= htmlspecialchars($signo2['fecha_inicio']) ?> - <?= htmlspecialchars($signo2['fecha_fin']) ?></small>
                    </div>
                </div>
            </div>
        </div>
