...
<body>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <section class="card">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="asunto" name="asunto" placeholder="Ej: Error PC01" value="<?= htmlspecialchars($asunto ?? '') ?>">
                        <!-- Placeholder para mensaje de error -->
                        
                        <span class="validation-error" id="error-asunto">
                                  <?php
                                  if (!empty($errores['asunto'])): ?>
                                      <?= htmlspecialchars($errores['asunto']) ?>
                                    </p>
                                  <?php endif; ?>
                        </span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipo_incidencia" name="tipo_incidencia">
                            ...
                            <?php foreach($incidencias as $i ): ?>
                              ...
                              <option value="<?php echo $i['id'] ?>" <?php echo ($i['id']==$tipo_incidencia) ? "selected" : ""  ?> >      <?php echo $i['tipo_incidencia'] ?></option>
                        ...
                        <span class="validation-error" id="error-tipo-incidencia">
                                  <?php
                                  if (!empty($errores['tipo_incidencia'])): ?>
                                      <?= htmlspecialchars($errores['tipo_incidencia']) ?>
                                    </p>
                                  <?php endif; ?>
                        </span>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group form-col-50">
                            ...
                            <input type="number" id="horas_estimadas" name="horas_estimadas" placeholder="Ej: 2" value="<?= htmlspecialchars($horas_estimadas ?? '') ?>">
                            <!-- Placeholder para mensaje de error -->
                  

                            <span class="validation-error" id="error-horas">
                                  <?php
                                  if (!empty($errores['horas_estimadas'])): ?>
                                      <?= htmlspecialchars($errores['horas_estimadas']) ?>
                                    </p>
                                  <?php endif; ?>
                        </span>
                    ...
                    <div class="form-actions">
                        <button type="submit" name="enviar" class="btn btn-save">
                            Guardar incidencia
                        </button>
                        <a name='cerrar' href="" class="btn btn-secondary btn-cancel">
                            Cancelar
                        </a>
                    </div>
                </form>
            ...
            <?php
              if (!empty($errores['crear'])): ?>
                <div id="flash-message-container">
                  <div class="flash-message error">
                    <?= htmlspecialchars($errores['crear']) ?>
                  </div>
