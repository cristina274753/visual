...
const mostrarAlta = function() {
    ...
    if (tipoBicicleta === "carretera") {
        // 
        nuevaBici = new Carretera(localizador, anio, false, numPlatos);
    } else if (tipoBicicleta === "montana") {
        nuevaBici = new Montaña(localizador, anio, false, numSuspensiones );
    }
...
const mostrarListado = function() {
    ...
    nuevaVentana.document.querySelector("body").innerHTML =tienda.listadoGeneral() + tienda.listadoCarretera() + tienda.listadoMontania() ;
};
