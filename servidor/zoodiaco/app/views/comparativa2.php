                        ...
                        <table class="table table-dark table-hover table-striped align-middle small">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width: <?= $comparativa['compatibilidad_amorosa'] ?>%;"
                                                aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?= $comparativa['compatibilidad_amorosa'] ?>%</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar bg-success" role="progressbar" style="width: <?= $comparativa['compatibilidad_emocional'] ?>%;"
                                                aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?= $comparativa['compatibilidad_emocional'] ?>%</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: <?= $comparativa['compatibilidad_laboral'] ?>%;"
                                                aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?= $comparativa['compatibilidad_laboral'] ?>%</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $comparativa['compatibilidad_social'] ?>%;"
                                                aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"><?= $comparativa['compatibilidad_social'] ?>%</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <a href="comparativa3?s1=<?= htmlspecialchars($signo1['id']) ?>&s2=<?= htmlspecialchars($signo2['id']) ?>" class="btn btn-outline-light btn-sm">Modificar</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
